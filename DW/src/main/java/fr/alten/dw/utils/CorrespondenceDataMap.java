...
/**
 * Utility class for data mapping. Use to make correspondence between java
 * beans's name or fields and a user-friendly name. Can be use for translation.
...
public class CorrespondenceDataMap {
	...
	private final HashMap<String, String> correspondenceColumnTable;

	private final HashMap<String, String> correspondenceToColumnTable;
	private final HashMap<String, String> correspondenceTable;

	private final HashMap<String, String> correspondenceToTable;
	...
	private CorrespondenceDataMap() {
		...
		this.fillCorrespondenceTable();
		this.fillCorrespondenceToTable();
		this.fillCorrespondenceColumnTable();
		this.fillCorrespondenceToColumnTable();
	}
