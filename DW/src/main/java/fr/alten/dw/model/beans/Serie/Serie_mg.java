...
public class Serie_mg implements Serializable {
	...
	private Double distance_source_to_reference_poInteger;
	...
	public Double getDistance_source_to_reference_poInteger() {
		return this.distance_source_to_reference_poInteger;
	}
	...
	public void setDistance_source_to_reference_poInteger(final Double distance_source_to_reference_poInteger) {
		this.distance_source_to_reference_poInteger = distance_source_to_reference_poInteger;
	}
